...
import { AccountDeletionTemplate } from './template/account-deletion.template';
import { DeactivateTemplate } from './template/deactivate.template';
import { EnableTwoFactorTemplate } from './template/enable-two-factor.template';
...
import { VerifyChannelTemplate } from './template/verify-channel.template';
